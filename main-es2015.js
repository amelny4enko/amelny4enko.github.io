...
/* harmony import */ var _pages_page_1_page_1_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/page-1/page-1.component */ "./src/app/pages/page-1/page-1.component.ts");
/* harmony import */ var _pages_page_2_page_2_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pages/page-2/page-2.component */ "./src/app/pages/page-2/page-2.component.ts");
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 5, vars: 0, consts: [["mat-align-tabs", "center"], ["label", "Page 1"], ["label", "Page 2"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _pages_page_1_page_1_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./pages/page-1/page-1.component */ "./src/app/pages/page-1/page-1.component.ts");
/* harmony import */ var _pages_page_1_page_1_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./pages/page-1/page-1.service */ "./src/app/pages/page-1/page-1.service.ts");
/* harmony import */ var _pages_page_2_page_2_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./pages/page-2/page-2.component */ "./src/app/pages/page-2/page-2.component.ts");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [
        _pages_page_1_page_1_service__WEBPACK_IMPORTED_MODULE_11__["Page1Service"],
    ], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_8__["AppComponent"],
        _pages_page_1_page_1_component__WEBPACK_IMPORTED_MODULE_10__["Page1Component"],
        _pages_page_2_page_2_component__WEBPACK_IMPORTED_MODULE_12__["Page2Component"]], imports: [_app_routing_module__WEBPACK_IMPORTED_MODULE_9__["AppRoutingModule"],
        _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_1__["BrowserAnimationsModule"],
        _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"],
        _angular_cdk_clipboard__WEBPACK_IMPORTED_MODULE_3__["ClipboardModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"],
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _pages_page_1_page_1_component__WEBPACK_IMPORTED_MODULE_10__["Page1Component"],
                    _pages_page_2_page_2_component__WEBPACK_IMPORTED_MODULE_12__["Page2Component"],
                ],
                imports: [
                    _app_routing_module__WEBPACK_IMPORTED_MODULE_9__["AppRoutingModule"],
                    _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_1__["BrowserAnimationsModule"],
...
/* harmony import */ var _page_1_constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./page-1.constants */ "./src/app/pages/page-1/page-1.constants.ts");
...
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/http.js");
/* harmony import */ var _page_1_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./page-1.service */ "./src/app/pages/page-1/page-1.service.ts");
...
function Page1Component_div_12_tr_2_td_1_Template(rf, ctx) { if (rf & 1) {
...
function Page1Component_div_12_tr_2_Template(rf, ctx) { if (rf & 1) {
...
function Page1Component_div_12_Template(rf, ctx) { if (rf & 1) {
...
class Page1Component {
    constructor(clipboard, httpClient, page1Service) {
    ...
    onCopy() {
        let str = '';
        this.data.slice(1).forEach((row) => str += `${row.slice(1).join('\t')}\n`);
        str += `Company\t${this.companyShort.toUpperCase()}\n`;
    ...
    onSearch() {
        ...
        const uns = Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["combineLatest"])(this.fetchData(Types.TABLE, '/cash-flow-from-financial-activities', ['Annual Cash Flow from Financial Activities']), this.fetchData(Types.TABLE, '/cash-flow-from-investing-activities', ['Annual Cash Flow from Investing Activities']), this.fetchData(Types.TABLE, '/cash-flow-from-operating-activities', ['Annual Cash Flow from Operating Activities']), this.fetchData(Types.TABLE, '/cash-on-hand', ['Quarterly Cash on Hand']), this.fetchData(Types.TABLE, '/current-ratio', ['Current Ratio Historical Data']), this.fetchData(Types.TABLE, '/ebit', ['Quarterly EBIT']), this.fetchData(Types.TABLE, '/ebitda', ['Quarterly EBITDA']), this.fetchData(Types.TABLE, '/eps-earnings-per-share-diluted', ['Quarterly EPS']), this.fetchData(Types.TABLE, '/gross-margin', ['Gross Margin Historical Data']), this.fetchData(Types.TABLE, '/gross-profit', ['Quarterly Gross Profit']), this.fetchData(Types.TABLE, '/net-cash-flow', ['Annual Net Cash Flow']), this.fetchData(Types.TABLE, '/net-income', ['Quarterly Net Income']), this.fetchData(Types.TABLE, '/net-profit-margin', ['Net Profit Margin Historical Data']), this.fetchData(Types.TABLE, '/number-of-employees', ['Annual Number of Employees']), this.fetchData(Types.TABLE, '/operating-income', ['Quarterly Operating Income']), this.fetchData(Types.TABLE, '/operating-margin', ['Operating Margin Historical Data']), this.fetchData(Types.TABLE, '/pe-ration', ['PE Ratio Historical Data']), this.fetchData(Types.TABLE, '/price-book', ['Price/Book Ratio Historical Data']), this.fetchData(Types.TABLE, '/price-fcf', ['Price to Free Cash Flow Ratio Historical Data']), this.fetchData(Types.TABLE, '/price-sales', ['P/S Ratio Historical Data']), this.fetchData(Types.TABLE, '/quick-ratio', ['Quick Ratio Historical Data']), this.fetchData(Types.TABLE, '/revenue', ['Quarterly Revenue']), this.fetchData(Types.TABLE, '/roa', ['ROA - Return on Assets Historical Data']), this.fetchData(Types.TABLE, '/roe', ['ROE - Return on Equity Historical Data']), this.fetchData(Types.TABLE, '/roi', ['ROI - Return on Investment Historical Data']), this.fetchData(Types.TABLE, '/shares-outstanding', ['Quarterly Shares Outstanding']), this.fetchData(Types.TABLE, '/total-common-preferred-stock-dividends-paid', ['Annual Total Common and Preferred Stock Dividends Paid']), this.fetchData(Types.TABLE, '/total-depreciation-amortization-cash-flow', ['Annual Total Depreciation and Amortization - Cash Flow']), this.fetchData(Types.TABLE, '/total-liabilities', ['Quarterly Total Liabilities']), this.fetchData(Types.TABLE, '/total-long-term-assets', ['Quarterly Total Long-Term Assets']), this.fetchData(Types.TABLE, '/total-long-term-liabilities', ['Quarterly Total Long Term Liabilities']), this.fetchData(Types.TABLE, '/total-share-holder-equity', ['Quarterly Share Holder Equity']), this.fetchData(Types.DATABASE, '/financial-ratios', ['Asset Turnover', 'Inventory Turnover Ratio', 'Receiveable Turnover']), this.fetchData(Types.CHART, null, ['Quarterly Shares Growth']), this.fetchData(Types.DISCOVERCI, null, ['Payables turnover'])).subscribe((tables) => {
            uns.unsubscribe();
            this.data = this.page1Service.createTable(this.minYear, this.head);
    ...
    fillTable(table) {
        if (table.length > 1) {
            const quarters = this.page1Service.quarters(this.minYear);
            ...
            ctable.forEach((row) => {
                ...
                const globalRowIndex = quarters.findIndex((quarter) => quarter.min <= time && time <= quarter.max);
                if (globalRowIndex !== -1) {
                    row.forEach((cell, cellIndex) => {
                        if (headMap[cellIndex] !== -1) {
                            ...
                            cell = String(cell).replace(/\./gi, ',');
                            this.data[globalRowIndex + 1][headMap[cellIndex]] = cell;
                        }
                    });
                }
            });
    ...
    fetchData(type, path, names) {
        if (this.getUrl(type, path)) {
            return this.httpClient.get(this.getUrl(type, path), { responseType: 'text' })
                ...
                const clearText = this.page1Service.clearText(response || '');
                switch (type) {
                    case Types.TABLE:
    ...
    parseTable(text, name) {
        ...
        rows.forEach((row) => {
            ...
            if (String(this.minYear) <= cells[0]) {
                cells.forEach((cell, cellIndex) => cells[cellIndex] = this.page1Service.getValue(cell));
                body.push(cells);
            }
        });
        return [head, ...body];
    ...
    parseDatabase(text, names) {
        ...
        const dataObj = this.page1Service.parseJSON(dataStr);
        if (!dataObj) {
            return [];
        }
        const head = ['Date'];
                ...
                if (item.field_name.includes(name)) {
                    ...
                    for (const e in item) {
                        if (item.hasOwnProperty(e) && !isNaN(new Date(e).getTime()) && String(this.minYear) <= e) {
                            if (head.length < 3) {
                                body.push([e.slice(0, 4), this.page1Service.getValue(item[e])]);
                            }
                            else {
                                body.find((row) => {
                                    if (row[0] === e.slice(0, 4)) {
                                        row.push(this.page1Service.getValue(item[e]));
                                    }
                                });
                            }
                        }
    ...
    parseChart(text, name) {
        ...
        dataObj.forEach((item) => {
            if (String(this.minYear) <= item.date) {
                body.push([item.date, this.page1Service.getValue(item.v3)]);
            }
        });
        return [head, ...body];
    }
...
Page1Component.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: Page1Component, selectors: [["app-page-1"]], decls: 13, vars: 5, consts: [[1, "page", "page-1"], [1, "head"], [1, "col"], ["placeholder", "https://www.macrotrends.net/...", 3, "ngModel", "ngModelChange"], ["placeholder", "https://www.discoverci.com/...", 3, "ngModel", "ngModelChange"], ["mat-flat-button", "", "color", "primary", 3, "disabled", "click"], ["mat-stroked-button", "", "color", "primary", 3, "disabled", "click"], ["mat-stroked-button", "", 3, "click"], ["class", "body", 4, "ngIf"], [1, "body"], [3, "ngClass", 4, "ngFor", "ngForOf"], [3, "ngClass"], [3, "innerHTML", 4, "ngFor", "ngForOf"], [3, "innerHTML"]], template: function Page1Component_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function Page1Component_Template_button_click_6_listener() { return ctx.onSearch(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](7, "Search");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](8, "button", 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function Page1Component_Template_button_click_8_listener() { return ctx.onCopy(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](9, "Copy");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](10, "button", 7);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function Page1Component_Template_button_click_10_listener() { return ctx.onClear(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](Page1Component, [{
    ...
    }], function () { return [{ type: _angular_cdk_clipboard__WEBPACK_IMPORTED_MODULE_4__["Clipboard"] }, { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClient"] }, { type: _page_1_service__WEBPACK_IMPORTED_MODULE_6__["Page1Service"] }]; }, null); })();
var Types;
(function (Types) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TABLE_HEAD", function() { return TABLE_HEAD; });
const TABLE_HEAD = [
    'Quarters',
    'Stock Price',
    'Quarterly Revenue',
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Page1Service", function() { return Page1Service; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");


class Page1Service {
    createTable(minYear, head) {
        const quarters = this.quarters(minYear);
        const data = [head];
        quarters.forEach((quarter) => {
            const row = [];
            head.forEach(() => row.push(0));
            row[0] = quarter.val;
            data.push(row);
        });
        return data;
...
Page1Service.ɵfac = function Page1Service_Factory(t) { return new (t || Page1Service)(); };
Page1Service.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: Page1Service, factory: Page1Service.ɵfac });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](Page1Service, [{
...
function Page2Component_tr_13_td_1_Template(rf, ctx) { if (rf & 1) {
...
function Page2Component_tr_13_Template(rf, ctx) { if (rf & 1) {
...
class Page2Component {
    ...
    fetchData(id) {
        const sub = this.httpClient.get(this.url(id))
            .subscribe((response) => {
            sub.unsubscribe();
            this.calc(id, response);
        });
    }
    calc(id, response) {
        var _a, _b, _c, _d, _e, _f;
        const currentPrice = (_c = (_b = (_a = response.chart) === null || _a === void 0 ? void 0 : _a.result[0]) === null || _b === void 0 ? void 0 : _b.meta) === null || _c === void 0 ? void 0 : _c.regularMarketPrice;
        const previousPrice = (_f = (_e = (_d = response.chart) === null || _d === void 0 ? void 0 : _d.result[0]) === null || _e === void 0 ? void 0 : _e.meta) === null || _f === void 0 ? void 0 : _f.previousClose;
    ...
    onCopy() {
        let str = '';
        this.data.forEach((row) => str += `${row.join('\t')}\n`);
        this.clipboard.copy(str);
    }
    onClear() {
        this.ids = '';
    ...
    url(id) {
        return `https://query1.finance.yahoo.com/v8/finance/chart/${id}`;
    }
}
...
Page2Component.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: Page2Component, selectors: [["app-page-2"]], decls: 14, vars: 4, consts: [[1, "page", "page-2"], [1, "content"], [1, "col"], [3, "ngModel", "ngModelChange"], ["mat-flat-button", "", "color", "primary", 3, "disabled", "click"], ["mat-stroked-button", "", "color", "primary", 3, "disabled", "click"], ["mat-stroked-button", "", 3, "click"], [4, "ngFor", "ngForOf"]], template: function Page2Component_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function Page2Component_Template_button_click_5_listener() { return ctx.onSearch(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](6, "Search");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](7, "button", 5);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function Page2Component_Template_button_click_7_listener() { return ctx.onCopy(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](8, "Copy");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](9, "button", 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function Page2Component_Template_button_click_9_listener() { return ctx.onClear(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](Page2Component, [{
    ...
    }], function () { return [{ type: _angular_cdk_clipboard__WEBPACK_IMPORTED_MODULE_1__["Clipboard"] }, { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }]; }, null); })();
