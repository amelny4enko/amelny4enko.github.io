...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AppComponent_tr_18_td_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      ...
      _createClass(AppComponent, [{
        ...
        value: function copy() {
          var clipboardString = '';
          this.table.slice(1).forEach(function (row) {
            return clipboardString += row.slice(1).join('\t') + '\n';
          });
          this.info.forEach(function (row) {
            return clipboardString += row.join('\t') + '\n';
          });
            ...
            return this.httpClient.get(this.getUrl(type, path), {
              ...
              switch (type) {
                ...
                case Types.SIMPLYWALL:
                  return _this5.parseSimplywall(clearText);
              }
            }));
          }
        ...
        key: "parseSimplywall",
        value: function parseSimplywall(text) {
          var _this9 = this;

          this.info = [];
          var infoArr = text.match(/<ul class="styled__DetailsSummary(.*?)ul>/gi) || [];
          infoArr = infoArr[0] && infoArr[0].match(/<li(.*?)li>/gi) || [];
          infoArr.forEach(function (item) {
            var key = item.slice(4, item.indexOf(':')).replace(/[<!\->]/gi, '');
            var valArr = item.match(/<span(.*?)span>|<a(.*?)a>/gi) || [];
            var valStr = valArr[0] && valArr[0].slice(valArr[0].indexOf('>') + 1, valArr[0].indexOf('</'));

            _this9.info.push([key, valStr]);
          });
          var descArr = text.match(/bopTyF"><p itemProp="description">(.*?)</gi) || [];
          var descStr = descArr[0] && descArr[0].slice(34, -1);
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 19,
      vars: 7,
      consts: [[1, "panel"], [1, "search"], [1, "field", "main"], ["placeholder", "https://www.macrotrends.net/...", 3, "ngModel", "ngModelChange"], [3, "disabled", "click"], [1, "field"], ["placeholder", "https://www.discoverci.com/...", 3, "ngModel", "ngModelChange"], ["placeholder", "https://www.simplywall.st/...", 3, "ngModel", "ngModelChange"], [1, "btn", 3, "click"], [1, "config"], ["class", "field", 4, "ngIf"], [1, "info"], [4, "ngFor", "ngForOf"], [1, "table"], [3, "ngClass", 4, "ngFor", "ngForOf"], [1, "label"], [1, "data"], [3, "ngClass"], [3, "innerHTML", 4, "ngFor", "ngForOf"], [3, "innerHTML"]],
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_input_ngModelChange_9_listener($event) {
            return ctx.simplywallInput = $event;
          });
